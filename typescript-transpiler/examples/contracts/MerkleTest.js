...
const merkle_patricia_forestry_1 = require("@aiken/merkle-patricia-forestry");
let MerkleTestContract = class MerkleTestContract {
    ...
    testMerkleFunctions(datum, redeemer, ctx) {
        ...
        const sliced = (0, merkle_patricia_forestry_1.sliceByteArray)(datum.data, 0n, 16n);
        // Test nibble extraction
        const firstNibble = (0, merkle_patricia_forestry_1.nibble)(datum.data, 0n);
        // Test hash combination
        const combined = (0, merkle_patricia_forestry_1.combineHashes)(datum.root, sliced);
