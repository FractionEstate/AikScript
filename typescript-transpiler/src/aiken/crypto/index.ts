// Aiken Crypto Module
// Functions from aiken-lang/stdlib/lib/aiken/crypto/
...
export declare type Data = Int | ByteArray | Data[] | Map<Data, Data> | { tag: Int; fields: Data[] };
export declare type Credential = { VerificationKey: VerificationKeyHash } | { Script: ScriptHash };

// Re-export Bool and Int for convenience
